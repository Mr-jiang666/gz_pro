...
class GuaziProSpiderMiddleware:
...
class GuaziProDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class my_proxy(object):
    def process_request(self,request,spider):
        ...
        proxy_name_pass = '16IRRYAO:435268'.encode('utf-8')
...
class scrapy_proxy_pool(object):
    def process_request(self,request,spider):
        # proxy，主机头和端口号
        ...
        # 你自己买的代理，用户名和密码肯定和我的不一样
        proxy_list = [
            "H2K9D2VE55R3R11D:109D54050BD2A0A1",
            "HNG4Q287RJB462TD:528643ADCC56E95F",
            "HM57J93I1TY6329D:2629A8EC7C775780",
            "HCG2W591OJ53I4WD:7634BE51597E88C7",
            "HF17A7NQBA10U95D:5FFEAD49CC964D3B",
            "H8S779L7449FN96D:963643413854E8A5",
        ]
        proxy_name_pass = random.choice(proxy_list).encode('utf-8')
        encode_pass_name = base64.b64encode(proxy_name_pass)
        # 将代理信息设置到头部去
        # 注意！！！！！Basic后面有一个空格
        request.headers['Proxy-Authorization'] = 'Basic '+encode_pass_name.decode()